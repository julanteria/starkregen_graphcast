...
gsutil -m cp "gs://dm_graphcast/params/GraphCast_operational - ERA5-HRES 1979-2021 - resolution 0.25 - pressure levels 13 - mesh 2to6 - precipitation output only.npz" .
gsutil -m cp "gs://dm_graphcast/params/GraphCast_small - ERA5 1979-2015 - resolution 1.0 - pressure levels 13 - mesh 2to5 - precipitation input and output.npz" .
...
move "GraphCast_operational - ERA5-HRES 1979-2021 - resolution 0.25 - pressure levels 13 - mesh 2to6 - precipitation output only.npz" "data\params\GraphCast_operational_ERA5-HRES_1979-2021_Resolution-0.25_PressureLevels-13_Mesh-2to6_PrecipitationOutputOnly.npz"
move "GraphCast_small - ERA5 1979-2015 - resolution 1.0 - pressure levels 13 - mesh 2to5 - precipitation input and output.npz" "data\params\GraphCast_small_ERA5_1979-2015_Resolution-1.0_PressureLevels-13_Mesh-2to5_PrecipitationInputOutput.npz"
:: End of script
